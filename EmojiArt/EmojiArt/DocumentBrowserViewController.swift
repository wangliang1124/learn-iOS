...
class DocumentBrowserViewController: UIDocumentBrowserViewController, UIDocumentBrowserViewControllerDelegate {
    ...
    func presentDocument(at documentURL: URL) {
        ...
        //        print("documentVC====:\(documentVC)")
        if let emojiArtiViewController = documentVC.contents as? EmojiArtViewController {
            emojiArtiViewController.document = EmojiArtDocument(fileURL: documentURL)
        }
